...
BOOKMARKLET_TITLE="エクスプレス予約からカレンダーに登録"
...
BOOKMARKLET_SCRIPT_URL="https://cdn.jsdelivr.net/gh/es-kumagai/Bookmarklet.JRExpressRideToCalendar@%%BRANCH%%/Bookmarklet.js"
